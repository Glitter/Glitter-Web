      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-2xl lg:max-w-3xl">
          ...
          <h1 className="mt-2 font-semibold text-3xl text-gray-900 leading-tight lg:text-5xl">
            {optimizeLineBreak('Terms of use')}
          </h1>
          <div className={styles.terms}>
            ...
            <p>
              ...
              and Glitter, concerning your access to and use of the
              https://tryglitter.com website as well as any other media form,
            ...
            <p>
              ...
              Policy: https://tryglitter.com/legal/privacy-policy. By using the
              Site, you agree to be bound by our Privacy Policy, which is
              incorporated into these Terms of Use. Please be advised the Site
              is hosted in the United States. If you access the Site from the
              European Union, Asia, or any other region of the world with laws
            ...
            <p>
              ...
              Croatia, Rijeka, and the Parties hereby consent to, and waive all
            ...
            <p>
              ...
              further information regarding use of the Site, you may email us at
              hello@tryglitter.com
            </p>
