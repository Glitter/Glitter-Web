    ...
    <main>
      <section className="py-4">
        <div className="mx-auto px-4">
          <img src={logo} className="h-auto w-48" />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-2xl lg:max-w-3xl">
          <Link href="/">
            <a className="inline-block mb-4">
              <FontAwesomeIcon icon={['fas', 'long-arrow-alt-left']} /> Go back
            </a>
          </Link>
          <span className="block text-gray-900">We respect your data</span>
          <h1 className="mt-2 font-semibold text-3xl text-gray-900 leading-tight lg:text-5xl">
            {optimizeLineBreak('Glitter Privacy Policy')}
          </h1>
          <p className="mt-12 text-gray-900 lg:text-l lg:mt-8 xl:text-xl">
            <b>Note:</b> In general, we will only collect the data that we
            absolutely need from you. At any time you can ask for details we
            have on you (no matter whether you are in EU or not). We don't rely
            on ads for our revenue so no need to whitelist the site if you are
            using an Ad Blocker.
          </p>
          <div className={styles.privacyPolicy}>
            <p>
              Thank you for choosing to be part of our community at Glitter. We
              ...
              information, please contact us at hello@tryglitter.com.
            </p>
            <p>
              When you visit our website https://tryglitter.com, and use our
            ...
            <p>
              ...
              our website (such as https://tryglitter.com), and/or any related
            ...
            <p>
              ...
              WITH ANYONE?" above), in United States, United Kingdom, and other
              countries.
            </p>
            <p>
            ...
            <p>
              ...
              under age 18, please contact us at hello@tryglitter.com.
            </p>
            ...
            <p>
              ...
              may email us at hello@tryglitter.com.
            </p>
            ...
            <p>
              ...
              You will be notified about data breaches when Atlas, craft for web
              development, owner Borna Šepić, Vrbovsko, Senjsko 18 believes you
              ...
              to your mental or physical well-being. In the event that Atlas,
              craft for web development, owner Borna Šepić, Vrbovsko, Senjsko 18
              becomes aware of a security breach which has resulted or may
              result in unauthorized access, use or disclosure of personal
              information Atlas, craft for web development, owner Borna Šepić,
              Vrbovsko, Senjsko 18 will promptly investigate the matter and
            ...
            <p>
              ...
              this privacy policy. We do respect the Do Not Track header when it
              comes to Google Analytics tracking.
            </p>
            ...
            <p>
              ...
              please submit a request via hello@tryglitter.com. We will respond
